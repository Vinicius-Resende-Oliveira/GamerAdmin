...
<div class="container login-container">
    <div class="row">
        <div class="col-md-6 mx-auto login-form-1">
			...
			<form method="POST" action="<?=BASE_URL?>user/connecting">
                ...
                <div class="form-group">
                	<p style="color: #eeffee;">Deseja se cadastrar? <a href="<?=BASE_URL?>user/register" class="ForgetPwd">Clique aqui</a></p>
                </div>
            </form>
        </div>
	</div>	
